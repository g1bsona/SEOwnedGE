...
MAKE_HOOK(CInventoryManager_ShowItemsPickedUp, Signatures::CInventoryManager_ShowItemsPickedUp.Get(), void, __fastcall,
	void* rcx, bool bForce, bool bReturnToGame, bool bNoPanel)
{
#ifdef DEBUG_HOOKS
	if (!CFG::Misc_Auto_Accept_Item_Drops[DEFAULT_BIND])
		return CALL_ORIGINAL(rcx, bForce, bReturnToGame, bNoPanel);
#endif

	if (CFG::Misc_Auto_Accept_Item_Drops)
	{
